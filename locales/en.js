export default {
  ...
  aboutPage: {
    ...
    text3:
      "The fruition of this belief is reflected in the domestic and Asian projects we present here. We have completed and operated numerous projects in countries such as Myanmar, Mongolia, and Israel, supporting these nations through employment.",
    title2: "Focus on Talent",
    text4: 'Our constant belief has been, "Change is an opportunity."',
    text5:
      'We consider investing in human talent as the best investment, always seeking individuals who "embrace change," and those who possess their own values, different from others.',
    text6:
      "Rather than seeking a stable life, we welcome individuals who aspire to become independent entrepreneurs using our company as a stepping stone. To support motivated young people, we also provide practical training opportunities, including overseas internships.",
    text7:
      "We hope you get to know our company, which continuously advances as a unique investment firm, and support us.",
    date: "September, 2017",
    ...
    row7_21:
      "EXE EXE Sakura Tower (Singapore): Management of Sakura Tower in Myanmar (Yangon) ",
    row7_22:
      "EXE Sakura Residence (Singapore): Management of Sakura Residence in Myanmar (Yangon) ",
    row7_23:
      "Sakura Thiripyitsaya (Singapore): Management of Thiripyitsaya Sanctuary Resort in Myanmar (Bagan)",
    ...
    row8_1: "1991",
    row8_2:
      "After resigning from Mitsubishi Corporation, Investment company EXE Corporation was established. Japan Telecom and EXE Corporation jointly established the first mobile phone company in Japan. ",
    row9_1: "1998",
    row9_2:
      "Launched the first hotel business in Vietnam (currently Hotel Nikko Hanoi). ",
    row10_1: "1999",
    row10_2:
      "Launched the first office building and hotel business in Myanmar (currently Sakura Tower, Thiripyitsaya Sanctuary Resort). ",
    row11_1: "2010",
    row11_2:
      "Established Sanaa EXE LLC, the first investment company in Mongolia from Japan. ",
    row12_1: "2014",
    row12_2:
      "Established Cardboard Technologies, the first investment and real estate business company in Israel. ",
    row13_1: "2016",
    row13_2:
      "Established Olonlog EXE, an educational business company in Mongolia, expanding into the education business.",
  },
  myanmarPage: {
    ...
    text2:
      "Floors 1 to 3 are dedicated to retail areas with a total leasable area of 1,183 square meters, housing major airlines' ticket offices, travel agencies, dental clinics, showrooms, and more.",
    text3:
      "Floors 5 to 19 are occupied by global companies and organizations such as JICA, Mitsubishi Corporation, Nikkei, NHK, and others.",
    title2: "Facilities:",
    line1: "24-hour backup power generation system",
    line2:
      "24-hour surveillance cameras and security personnel for constant maintenance and security",
    ...
    text5:
      "From the residence, you can enjoy a splendid view of the golden Shwedagon Pagoda.",
    text6:
  ...
  mongoliaPage: {
    ...
    text2_1:
      "EXE Corporation is one of the major institutional investors and also serves as a board member of BDSec JSC, Mongolia's largest securities company.",
    text2_2:
      "Through its local subsidiary, Turquoise Finance, a financial service company licensed by the Mongolian Financial Regulatory Commission, we conduct business in the Mongolian financial market together with BDSec. This includes underwriting stocks and bonds on the Mongolian Stock Exchange and the Over-the-Counter (OTC) market.",
    text2_3:
      "In addition to underwriting activities, Turquoise Finance directly issues loans to local businesses, and acting as a market maker in the non-banking financial market sector.",
  },
  aboutExe: {
    title1: "About",
    text1:
  ...
  domesticPage: {
    ...
    text1:
      "We engage in a business that maximizes the value of real estate by conducting value-up activities based on area markets and needs, mainly targeting central urban areas. From acquisition to renovation, leasing, property management, and sale, we handle the entire process.",
    title2: "Real Estate Rental Business",
    text2:
      "We own residential buildings, commercial buildings, parking lots, and other properties primarily in central urban areas. By utilizing various expertise, we maintain high occupancy rates and achieve stable rental income. Additionally, we focus on the share house and guest house business, which involves renovating properties with excellent design, offering new lifestyle spaces for domestic and international students and individuals living alone.",
    title3: "Real Estate Investment Business",
    text3:
      "We are involved in acquiring real estate-backed bonds and engaging in M&A activities of real estate holding companies. Proactively, we pursue new investment ventures that combine real estate and finance, without overlooking changes in the market.",
    ...
    text5:
      "In addition to real estate investment business, we also emphasize unique investment opportunities in education, art, and services for investors. Each proposal is carefully tailored to meet the needs of individual clients after thorough consultation.",
    title6: "Project Examples",
    text6_1: "Financial Business",
    text6_2: "Education Business",
    text6_3:
      "Art Investment Business (including Man Ray Photography Collection and Hokusai's Thirty-Six Views of Mount Fuji)",
  },
  internshipPage: {
    ...
    text1:
      "Our Business Internship program was created to support individuals who seek change and have their own unique values. Rather than a typical internship, it serves as a platform for long-term practical training in the business field.",
    ...
    frame_text1_4:
      "Anxious about being in a foreign country for the first time",
    frame_text1_5:
      "Want to gain practical experience, not just language skills",
    frame_title2: "With Exe's Business Internship program:",
    frame_text2_1:
      "Since 2000, we have been accepting interns, and over 40 students and professionals have participated. ",
    title1: "Here are some testimonials from internship participants:",
    text1_1:
      "S.I, Ritsumeikan Asia Pacific University, International Business Major: ",
    text1_2:
      '▶ "Meeting people from different nationalities". 3 months were a short but stimulating experience that broadened my perspective. The opportunity to interact with professionals in the business world was invaluable, providing advice on job hunting and insights into working overseas and women in the workforce.',
    text1_3:
      "▶ Safe study abroad system even in an unstable situation. Under the military regime, I was anxious, but I was able to concentrate on my internship without any inconvenience because of the generous support from everyone from the initial visa arrangements to the final returning to Japan. Not only did I receive advice that helped me grow both in terms of my life and work, but I also had opportunities to consult with them regularly about my job hunting activities.",
    text1_4: "T.M, Tokyo University of Foreign Studies, Burmese Studies: ",
    text1_5:
      '▶ "The communication with the local staff". I was worrying about the completely different life style in Myanmar rather than Japan. But by daily communication withe Myanmar staffs quickly dispelled my anxieties. Not only did I learn about business, but I also managed to acquire Burmese language skills through conversations with the staff. The warmth of the people I met during this internship left a lasting impression, and I feel that I have grown as a person.',
    text1_6:
      '▶ "I was amazed by the safety and warmth of the people in Myanmar". What impressed me most about this internship was the warmth of the people. From start to finish, the hotel staff was so kind to me and treated me like a true family member. Every day was really fulfilling and passed by so quickly. I will never forget this experience, and I think I have grown more than before after completing the internship.',
    ...
    text1_9:
      '▶ "Challenging schedule of the internship". The internship period was two weeks. My main job was to share my sense of cleanliness as a Japanese person with the local staff. I knew nothing about the hotel industry, so it was a lot of pressure for me to share my own ideas for improvement, but the Japanese managers supported me as much as possible. It was my nourishment to feel the process of striving for the aim of achieving my goals even though I struggling. It was a challenging internship for me, but it was a very intense two weeks. I would recommend that you should participate for at least half a year.',
    title2: "Universities of our interns",
    text2_1:
      "Waseda University, Meiji University, Sophia University, APU, Meiji Gakuin University, Kokushikan Univeristy, Shizuoka University, etc.",
    text2:
      "The idea of interning abroad may seem daunting, but taking this small step can become a valuable asset in your life. ",
    text3:
      "Our goal is to encourage you to take that leap, whether you want to challenge yourself, make a change in your life, or explore new opportunities. We are looking forward to your challenges.",
    table1: "Company Overview",
    table1_row1_1: "Period:",
    table1_row1_2: "Ongoing",
    table1_row2_1: "Eligibility: ",
    table1_row2_2:
      "Open to all, regardless of age and work experience. Students are welcome to apply.",
    table1_row3_1: "Qualifications:",
    table1_row3_21: "Interest and love for Asia.",
    table1_row3_22:
      "Curious and motivated individuals interested in hotel operations and improvement.",
    table1_row3_23:
      "Those who want to acquire skills in service at a resort hotel, develop an international mindset, and improve their English proficiency.",
    table1_row3_24:
      "Individuals who want to test their English and other language abilities.",
    table1_row3_25:
      "Those seeking a unique overseas experience, not just a typical trip.",
    ...
    table1_row6_23:
      "（*Includes airfare from Japan to Yangon, transportation from Yangon to Bagan, overseas travel insurance, etc.）",
    table1_row6_24: "Cost of living, including meals. ",
    table1_row6_25:
      "※ Participants must gather at the designated location (Yangon) on their own.",
    table1_row7_1: "Company-covered: ",
    table1_row7_2:
      "Partial or full subsidies for accommodation, meals, and commuting expenses.",
    ...
    table1_row8_23:
      "Separate selection is required for those interested in full-time positions. ",
    table1_row8_24:
      "※ There are cases that previous interns have been hired for full-time positions.",
    table1_row8_25:
      "Before traveling, a hepatitis B test and overseas insurance are required.",
    table1_row8_26:
      "Participants must agree to the terms of the internship agreement.",
    table1_row8_27:
      "Please prepare approximately 1000 USD as minimum pocket money for the trip.",
    table1_row8_28: "",
    ...
    table2_row1_21:
      "Arrival in Yangon, Orientation, Uniform, Start of Sakura Café training",
    ...
    table2_row15_2:
      "You will learn the essential tasks in a food and beverage establishment, including dishwashing and cleaning, and gain fundamental knowledge crucial for food service. You will practice being a barista, using specialized machines to brew coffee, and learn how to make fresh juice and other beverages.",
    table2_row16_1: "Restaurant training",
    table2_row16_2:
      "During the restaurant training, you will handle inventory and cleaning tasks, set up tables and the bar area, and learn how to provide customer service in English. Additionally, you will learn to create cocktails and desserts and put your skills into practice.",
    table2_row17_1: "Bar training ",
    table2_row17_2:
      "In the bar training, you will be responsible for ticket sales and management, checking inventory and cleanliness, and setting up tables and the bar area. You will also carry out customer service duties in English.",
    ...
    table3_row15_2:
      "You will learn the basics of working in a food and beverage establishment, including dishwashing, cleaning, and essential skills for a barista, such as using specialized coffee machines and preparing fresh juice. ",
    table3_row16_1: "Reception Training",
    table3_row16_2:
      "You will also practice providing customer service in English and learn how to create cocktails and desserts. During the reception training, you will handle inventory and cleaning tasks, set up tables and the bar area, and learn how to provide customer service in English.",
    text6:
      "Sakura Tower, a landmark in Yangon, houses prominent global companies and organizations such as JICA, Mitsubishi Corporation, Nikkei, and NHK. It attracts expatriates and tourists from Europe, Asia, and other overseas locations.",
    text_frame:
      "At Sakura Residence, approximately 30% of residents are Japanese, and 70% are expatriates from Europe and Asia. English customer service is a daily occurrence.",
    ...
    frame2_title4:
      "NRT (Narita Airport) ⇒ BKK (Bangkok, Thailand, layover) ⇒ RGN (Yangon International Airport)",
    frame2_text4_1:
      "Depending on the season, there may also be direct flights between Japan and Yangon. Local staff will provide transportation from Yangon International Airport, so you can rest assured.",
    frame2_title5:
      "The currency used is the dollar and chat (MMK), and the monthly food cost is approximately 30,000 yen (*subject to change depending on the season).",
    frame2_text5_1:
    ...
    answer1:
      'Myanmar, known as "Asia Last Frontier," is a multicultural nation with a population of 53.8 million and 135 ethnic groups. It was a former British colony and uses Burmese and English as official languages. Approximately 90% of the population practices Buddhism, and pagodas adorn the cityscape. The people are known for their simplicity, gentleness, and similarities to the Japanese temperament.',
    question2: "How frequently is English used? ",
    answer2:
      "English is used for communication with overseas expatriates and local staff. Interaction with local staff may involve speaking Burmese as well.",
    question3: "Are there any language requirements such as TOEIC? ",
    answer3:
      "For short-term internships (within three months), having an English proficiency of around TOEIC 800 points can provide broader opportunities for various tasks. For longer internships (e.g., six months), initial English proficiency is not mandatory, but having around TOEIC 600 points is desirable.",
  ...
  recruitPage: {
    ...
    head_title3: "Believe in your own values, not just what others think.",
    text1:
      'Our constant belief has been, "Change is an opportunity." Embracing the change as a business chance without faltering in the face of changing times is the spirit of our company. ',
    ...
    row2_22:
      "You will be in charge of all operations related to office buildings, serviced apartments, hotels and restaurants owned in Myanmar.",
    row2_23:
      "Sales, engineering, accounting, human resources and general affairs, etc.",
    row2_24: "Sakura Tower",
    row2_25: "Yangon landmark tower",
    row2_26:
      "Many Japanese companies have offices, and the rooftop bar “Yangon Yangon” located on the top floor has become the center of entertainment in Myanmar.",
    ...
    row4_21:
      "Document Screening, Interview Examination, English Test, and Final Assessment through a one-week internship training in Yangon.",
    row5_1: "Selection Criteria",
    row5_21: "Individuals interested in Asia and those who love Asia. ",
    row5_22:
      "Candidates with courage and charisma, and those interested in learning Myanmar language are welcome.",
    row6_1: "Required Documents",
    row6_2: "Resume (Career history sheet for mid-career applicants)",
    row7_1: "Estimated Annual Income",
    row7_2:
      "Annual income: 2.8 to 5 million JPY (Details will be provided during the initial interview)",
