...
export default function Navbar({ fixed }) {
  ...
  const { locale } = router;
  const t = locale === "jp" ? jp : cn;
  if(locale == "cn") {
    console.log(locale);
    const t = locale === "cn" ? cn : jp;
  }
  ...
  return (
    <>
      <div
        style={{ marginTop: "30px", marginRight: "70px" }}
        className="sticky2 active:border-[3px] active:border-r-0 border-cyan-600 active:rounded mt-[10px] my-[3px] lg:block"
      >
      ...
      >
        <div className="container pl-8 mx-auto flex flex-wrap items-center justify-start ml-0">
          <div className="w-full relative flex justify-start lg:w-auto lg:static lg:block">
            ...
            >
              <i
                className="fas fa-bars sm:mr-4 md:mr-8 lg:mr-0"
                ...
                <li className="nav-item1">
                  <div className="flex justify-center">
                    <div className="dropdown text-white">
                      ...
                      <div
                        className="dropdown-content text-left flex-col"
                        style={{ minWidth: 200, paddingLeft: "10px" }}
                      >
                        <Link
