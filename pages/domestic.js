        ...
        <div className="max-w-[1200px] mx-auto">
              ...
              <div className="sm:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 -mt-4">
                ...
                <div className="md:px-10 px-4">
                  <div className="w-full md:mx-8 py-4">
                    ...
                    <p className="text-lg font-medium text-gray-500 text-justify mt-4 font-sans text-gray-500 text-justify">
                  ...
                  <div className="w-full md:mx-8 py-4">
                    ...
                    <p className="text-lg font-medium text-gray-500 text-justify mt-6 font-sans text-gray-500 text-justify">
          ...
          <div className="px-4">
            <div className="text-2xl md:text-3xl font-bold box-content h-32 w-auto p-10 border-0 bg-[#f6fafd] mb-4 text-gray-700">
              ...
              <div className="mt-4 md:ml-5 text-gray-500 text-lg font-medium text-gray-500 text-justify">
                -{t.domesticPage.text4_1}
                <br></br>-{t.domesticPage.text4_2} <br></br>-
            ...
            <div className="pt-2">
              ...
              <p className="py-2 text-lg font-medium text-gray-500 text-justify">
          ...
          <div className="px-4 py-6">
            <div className="text-2xl md:text-3xl font-bold box-content lg:h-32 w-auto p-10 border-0 bg-[#f6fafd] text-gray-700">
              ...
              <div className="text-lg font-medium text-gray-500 text-justify mt-5 md:ml-5 text-gray-500">
                -{t.domesticPage.text6_1}
                <br></br>-{t.domesticPage.text6_2}
                <br></br>-{t.domesticPage.text6_2}
              </div>
            </div>
          </div>
